...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{asset('assets/auth/images/logo-white-3.png')}}" alt="">
                <img class="logo-compact" src="{{asset('assets/auth/images/logo-text-white.png')}}" alt="">
                <img class="brand-title" src="{{asset('assets/auth/images/logo-text-white.png')}}" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="{{asset('assets/auth/images/profile/11.jpeg')}}" width="20" alt="">
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    @csrf 
                                    <button class="dropdown-item ai-icon"><svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
					...
					<li><a class="ai-icon" href="{{asset('event-management.blade.php')}}" aria-expanded="false">
    ...
    ***********************************-->
    ...
    <script src="{{asset('assets/auth/js/dlabnav-init.js')}}"></script>	
	
	<!-- Chart sparkline plugin files -->
    <script src="{{asset('assets/auth/vendor/jquery-sparkline/jquery.sparkline.min.js')}}"></script>
	<script src="{{asset('assets/auth/js/plugins-init/sparkline-init.js')}}"></script>
    ...
    <!-- Init file -->
    <script src="{{asset('assets/auth/js/plugins-init/widgets-script-init.js')}}"></script>
	
	<!-- Demo scripts -->
    <script src="{{asset('assets/auth/js/dashboard/dashboard.js')}}"></script>
	
	<!-- Summernote -->
    <script src="{{asset('assets/auth/vendor/summernote/js/summernote.min.js')}}"></script>
    <!-- Summernote init -->
    <script src="{{asset('assets/auth/js/plugins-init/summernote-init.js')}}"></script>
	
	<!-- Svganimation scripts -->
    <script src="{{asset('assets/auth/vendor/svganimation/vivus.min.js')}}"></script>
    <script src="{{asset('assets/auth/vendor/svganimation/svg.animation.js')}}"></script>
    <script src="{{asset('assets/auth/js/styleSwitcher.js')}}"></script>
