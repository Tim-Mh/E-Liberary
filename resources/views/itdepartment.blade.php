					...
					<div class="col-xs-11 text-right menu-1">
						<ul>
							...
							<li class="has-dropdown">
								<a href="#">Courses</a>
								<ul class="dropdown">
									<li><a href="{{url('#')}}">IT Department</a></li>
		...
		<div class="container-fluid proj-bottom">
			<div class="row">
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="{{url('itbookone')}}"><img src="images\it-1.png" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<!--<h3>The Clean Coder</h3>-->
				        <span>View Course</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="images/it-2.png" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<!--<h3>Introduction to Algori</h3>-->
						<span>View Course</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="images/it-3.png" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<!--<h3>code</h3>-->
						<span>View Course</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="images/it-4.png" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>HTML&CSS</h3>
						<span>View Course</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="images/it-5.png" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<!--<h3>Virtual Assistant</h3>-->
						<span>View Course</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="images/it-6.png" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<!--<h3>Virtual Assistant</h3>-->
						<span>View Course</span>
					</a>
				</div>
