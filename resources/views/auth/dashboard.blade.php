    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
                <div class="card">
                    <img class="img-fluid" src="{{asset('assets/auth/images/courses/pic1.jpg')}}" alt="">
                    <div class="card-body">
            ...
            <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
                <div class="card">
                    <img class="img-fluid" src="{{asset('assets/auth/images/courses/pic2.jpg')}}" alt="">
                    <div class="card-body">
            ...
            <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
                <div class="card">
                    <img class="img-fluid" src="{{asset('assets/auth/images/courses/pic3.jpg')}}" alt="">
                    <div class="card-body">
            ...
            <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
                <div class="card">
                    <img class="img-fluid" src="{{asset('images/courses/pic4.jpg')}}" alt="">
                    <div class="card-body">
